...
const Hero = () => {
    return (
        <div id="printersHero" className="printer-banner-section position-relative text-white d-flex align-items-center" style={{ height: '90vh', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    ...
                    <Row>
                        <Col md={6}>
                            ...
                            <p className="fs-5" style={{ fontWeight: '700', textShadow: '3px 3px 8px rgba(0, 0, 0, 0.9)', marginTop: '0.5rem', marginBottom: '2rem' }}>
                                Trabajamos con marcas que nos brindan calidad y sustento para una mejor impresion constante.
                            </p>
                        </Col>
                    </Row>
                </Layout>
