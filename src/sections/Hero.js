...
const Hero = () => {
    return (
        <div id="home" className="banner-section position-relative text-white d-flex align-items-center" style={{ height: '100vh', backgroundImage: 'url(/your-background-image.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            {/* Blur hacia abajo */}
            <div className="blur-effect position-absolute w-100" style={{ bottom: '-50px', height: '100px', background: 'linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0))', filter: 'blur(20px)', zIndex: 2 }}></div>
        </div>
    );
};
